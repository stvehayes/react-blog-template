(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var _a$1 = stepsOrder$1.reduce(function (acc, key) {
        ...
        sync: {},
        cancelSync: {}
    }), steps$1 = _a$1.steps, sync$1 = _a$1.sync, cancelSync$1 = _a$1.cancelSync;
    ...
    var getFrameData = function () { return frame$1; };
    ...
    var decay = function (props) {
        ...
        return action(function (_a) {
            ...
            var process = sync$1.update(function (_a) {
                ...
                update(current);
                if (!isMoving) {
                    cancelSync$1.update(process);
                    complete();
                }
            }, true);
            return {
                stop: function () { return cancelSync$1.update(process); }
            };
        });
    };
    ...
    var multitouch = function (_a) {
        ...
        return action(function (_a) {
            ...
            return {
                stop: function () {
                    cancelSync$1.update(updatePoint);
                    updateOnMove.stop();
                }
            };
        });
    ...
    var styler = function () {
        return invariant$2(false, 'styler has been removed from Popmotion in 9.0. Downgrade to 8.x or npm install stylefire');
    };
